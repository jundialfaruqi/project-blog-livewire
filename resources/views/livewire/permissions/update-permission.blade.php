            ...
            <div class="card-body">
                ...
                <div class="space-y-4">
                    <div class="alert backdrop-blur-md bg-primary-content/90 border border-white/20 shadow">
                        <div class="text-sm">
                            <p class="font-medium mb-2">Panduan Edit Permission:</p>
                            <ul class="list-disc list-inside space-y-1">
                                <li>Nama permission harus unik</li>
                                <li>Gunakan format action-resource</li>
                                <li>Pilih roles yang sesuai</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="alert backdrop-blur-md bg-primary-content/70 border border-white/20 shadow">
                        <div class="text-sm">
                            ...
                            <ul class="list-disc list-inside space-y-1">
                                <li>Perubahan akan mempengaruhi semua role yang memiliki permission ini</li>
                                <li>Permission dapat dimiliki oleh multiple roles</li>
                                <li>Gunakan kebab-case untuk nama permission</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="alert backdrop-blur-md bg-primary-content/50 border border-white/20 shadow">
                        <div class="text-sm">
                            ...
                            <ul class="list-disc list-inside space-y-1">
                                <li>Review assignment roles secara berkala</li>
